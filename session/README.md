...
**Version 3.8.5** - Status Persistence: Session status now tracked in .auto-capture-state with backward compatibility
...
[![Version](https://img.shields.io/badge/version-v3.8.5-blue.svg)](https://github.com/awudevelop/claude-plugins)

---

## 🚀 What's New in v3.8.5 (Latest Update)
