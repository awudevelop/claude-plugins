...
import { Adapter, AdapterContext, AdapterFactory } from '@mockdata/adapters';
...
```typescript
import { configureDataLayer } from '@mockdata/config';
import { createFetchAdapter } from '@mockdata/adapters/fetch';
...
import { configureDataLayer } from '@mockdata/config';
import { createFetchAdapter } from '@mockdata/adapters/fetch';
import { createSupabaseAdapter } from '@mockdata/adapters/supabase';
