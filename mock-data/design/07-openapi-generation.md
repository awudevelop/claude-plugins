...
MockData can generate OpenAPI 3.0 specifications from FE schema definitions. This enables:
...
npx mockdata generate:postman --output ./postman.json
```

## Programmatic Usage

```typescript
import { generateOpenAPI } from '@mockdata/generator/openapi';
