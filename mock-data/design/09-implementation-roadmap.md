...
This document outlines the implementation phases for MockData, from MVP to full feature set.
...
### Deliverables
- `mockdata generate` command
- `mockdata generate:openapi` command
- `mockdata generate:postman` command
